...
export const idlService = IDL.Service({
  ...
  'deleteMainImageForBird' : IDL.Func([IDL.Text], [], []),
  ...
  'getMainImage' : IDL.Func([IDL.Text], [IDL.Opt(IDL.Text)], ['query']),
  ...
  'setMainImage' : IDL.Func([IDL.Text, IDL.Text], [IDL.Text], []),
